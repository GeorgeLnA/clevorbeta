...
const SocialConnect = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4 font-fustat w-full">
      <div className="w-full max-w-3xl mx-auto text-center mb-16">
        <h1 className="text-6xl md:text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-clevor-persian-blue via-clevor-teal to-clevor-blue-44 mb-6">
          Connect <span className="text-clevor-persian-blue">With Us</span>
        </h1>
        <p className="text-xl text-clevor-cod-gray max-w-2xl mx-auto">
      ...
      <div className="relative w-full max-w-2xl">
        ...
        <div 
          className={`rounded-3xl bg-white border border-clevor-grey-96 shadow-2xl overflow-hidden p-8 transition-all duration-500 hover:scale-105`}
          style={{
            boxShadow: '0 0 50px rgba(52, 27, 204, 0.1), 0 0 80px rgba(185, 242, 225, 0.1)'
          }}
        >
            ...
            <a href="#" className="social-icon instagram">
              <div className="icon-container">
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="h-8 w-8 text-clevor-persian-blue"
      ...
      <style jsx>{`
        ...
        .icon-container {
          ...
          align-items: center;
          background: rgba(52, 27, 204, 0.05);
          box-shadow: 0 8px 32px rgba(52, 27, 204, 0.1);
          backdrop-filter: blur(4px);
          -webkit-backdrop-filter: blur(4px);
          border: 1px solid rgba(52, 27, 204, 0.1);
        }
        ...
        .icon-container::before {
          ...
          bottom: 0;
          border-radius: 50%;
          background: radial-gradient(circle at center, rgba(52, 27, 204, 0.1) 0%, transparent 70%);
          opacity: 0;
