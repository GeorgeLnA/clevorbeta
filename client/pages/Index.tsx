                ...
                <div className="grid gap-[50px]">
                  ...
                  <div className="flex items-center gap-[30px]">
                    ...
                    <div>
                      ...
                      <p className="text-clevor-mine-shaft font-fustat text-xl font-light leading-[30px]">
                        Your private keys never leave the card, ensuring
                        absolute control.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-[30px]">
                    <div className="flex-shrink-0">
                      ...
                      >
                        <path
                          d="M40.0015 16.5669C36.9203 16.5669 33.9653 17.7909..."
                          fill="url(#paint0_linear_5_334)"
                        />
                        <defs>
                          <linearGradient
                            id="paint0_linear_5_334"
                            x1="1.26242"
                            y1="39.8012"
                            x2="99.8635"
                            y2="39.9049"
                    ...
                    <div>
                      ...
                      <p className="text-clevor-mine-shaft font-fustat text-xl font-light leading-[30px]">
                        A replacement card retains the same private key,
                        removing the need for manual backups.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-[30px]">
                    ...
                    <div>
                      ...
                      <p className="text-clevor-mine-shaft font-fustat text-xl font-light leading-[30px]">
                        Easily top up your spending balance from your Web3
                  ...
                  <div className="flex items-center gap-[30px]">
                    ...
                    <div className="min-w-[860px]">
                      ...
                      <p className="text-clevor-mine-shaft font-fustat text-xl font-light leading-[30px]">
                        Top up your card 100% on-chain by simply signing a
                        transaction from your Web3 wallet. Your assets are
                        seamlessly converted and credited to your card balance,
                        ready for spending anywhere Mastercard or Visa is
                        accepted. No intermediaries, no delays—just pure
                  ...
                  <div className="flex items-center gap-[30px]">
                    ...
                    <div>
                      ...
                      <p className="text-clevor-mine-shaft font-fustat text-xl font-light leading-[30px]">
                        Integrated cryptographic security and tamper-resistant
                        technology.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-[30px]">
                    ...
                    <div>
                      ...
                      <p className="text-clevor-mine-shaft font-fustat text-xl font-light leading-[30px]">
                        No setup complexity; works instantly like a traditional
                        bank card.
                      </p>
                    </div>
                  </div>
            ...
            <div className="max-w-[1140px] mx-auto text-center">
              <div className="mb-16">
                ...
                <p className="text-clevor-emperor font-fustat text-2xl font-light leading-9 max-w-[912px] mx-auto">
                  The Clevor Card is your bridge between decentralized finance
                  (DeFi) and the traditional financial world (Tradfi). By
                  linking crypto to existing banking infrastructures through
                  Visa or Mastercard, our users can seamlessly spend and store
                  cryptos, with the additional possibility to authenticate
                  online with the Fido2 Functionality
                </p>
              </div>
